...
month_index <- format(lst_time, "%m")  # Extract the month as a character vector

# Convert the month index to a numeric vector to use in stackApply

# Use stackApply to calculate the monthly mean LST
